...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("公司基本信息", "hithink-basicinfo-query"),
        ("公司简介", "hithink-basicinfo-query"),
        ("企业简介", "hithink-basicinfo-query"),
        ...
        ("质押比例变化", "hithink-management-query"),
        ("股东质押比例变化", "hithink-management-query"),
        ("股东户数变化", "hithink-management-query"),
        ("实控人变化", "hithink-management-query"),
