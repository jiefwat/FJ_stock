...
export type DecisionPresentation = { action: string; summary: string; severity: "critical" | "high" | "action" | "info"; user_required: boolean; reason_code: string; layer: "priority" | "review" | "watch_only" | "high_risk" | null };
...
export type DecisionEvent = { id: number; source: "holding" | "opportunity"; subject_key: string; symbol: string; name: string; strategy: string | null; previous_action: string; action: string; summary: string; severity: "critical" | "high" | "action" | "info"; user_required: boolean; reason_code: string; href: string; observed_at: string; created_at: string; read_at: string | null; email_status: "not_required" | "pending" | "sent" | "failed"; email_attempts: number; email_error: string | null; email_sent_at: string | null };
